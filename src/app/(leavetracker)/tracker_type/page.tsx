...
export default async function TrackerPage(){
    ...
    return (
      <>
        ...
        <p className="mt-4 px-4 py-2 text-sm text-black/90 dark:text-white/70 backdrop-blur-md rounded-md shadow-sm opacity-40">No tracker type found , add new tracker type in the menu</p>
      )}
